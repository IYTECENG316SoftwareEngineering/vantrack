...
import com.example.zanabucinca.vantrackv10.Simulator.VanSimulator;
...
public class MapsActivityPresenterImpl implements MapsActivityPresenter {
    ...
    private final String DEFAULT_UPDATE_INTERVAL = "5000";
    ...
    private VanSimulator vanSimulator;

    public MapsActivityPresenterImpl(MapsView mapsView, Context context){
        this.context = context;
        this.mapsView = mapsView;
        vanSimulator = new VanSimulator(new User("Test",1,"Driver",true),true);
    }
    //for broadcast to mapsActivity about internet connection
    ...
    public void toStartGetAllUsersTask(){
        ...
        vanSimulator.moveVan();
        new UpdateUserTask(vanSimulator.getVan()).execute(apiConnector);
